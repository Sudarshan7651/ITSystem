    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('student.login') }}">
            ...
            <div class="form-group">
                ...
                <input id="student_email" type="email" name="email" value="{{ old('email') }}" placeholder="student@example.com" required />
                @error('email') <span class="input-error">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="student_password">Password</label>
                <input id="student_password" type="password" name="password" placeholder="••••••••" required />
