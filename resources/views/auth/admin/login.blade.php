...
<head>
    ...
    <title>Admin Login — Internship Tracking System</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .links { text-align: center; font-size: 13px; color: rgba(255,255,255,0.35); }
        .links a { color: rgba(255,255,255,0.65); text-decoration: none; font-weight: 500; }
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="form-group">
                ...
                <input id="admin_email" type="email" name="email" value="{{ old('email') }}" placeholder="admin@example.com" required />
                @error('email') <span class="input-error">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="admin_password">Password</label>
                <input id="admin_password" type="password" name="password" placeholder="••••••••" required />
