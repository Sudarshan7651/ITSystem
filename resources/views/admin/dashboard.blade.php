...
<head>
    ...
    <title>Admin Dashboard — Internship Tracking System</title>
...
<body>
    ...
    <main>
        <h1>Dashboard <span class="role-badge">Admin</span></h1>
        <p class="subtitle">Overview of the Internship Tracking System</p>
        <div class="cards">
            <div class="card">
